...
def main(argv: Optional[List[str]] = None):
    ...
    p_gp.add_argument("notes", nargs="?", default="Phase gate review passed",
                       help="Gate notes")
    ...
    subparsers.add_parser("delegation-md", help="Regenerate AGENT_DELEGATION.md §8")
...
def _dispatch(args, db, config):
    ...
    # ── Core task commands (PoC) ──
        ...
        cmd_done(db, config, args.task_id, args.skip_break)
    ...
    # ── Phase & gate commands ──
        ...
        cmd_confirm(db, args.task_id, args.confirmed_by, args.reasons)
    ...
    # ── Knowledge ──
        ...
        cmd_promote(config, args.pattern, args.rule)
