...
> 📂 Tier definitions, assignment rules, and delegation map template in `~/.claude/frameworks/delegation.md`.
...
> 📂 Full escalation ladder in `~/.claude/frameworks/delegation.md`.
...
> 📂 Parallelism rules and Human/AI role division in `~/.claude/frameworks/delegation.md`.
