...
1. Write the spec files to `specs/` using schemas from `references/spec-output-schemas.md`
2. Run the quality rules from `references/spec-output-schemas.md` before finalizing
