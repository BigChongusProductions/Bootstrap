...
bash db_queries.sh triage <id> <phase>    # Triage inbox → planned work
```
...
bash db_queries.sh add-task <phase> ...    # Manually add task
...
| `/Users/chonkius/Desktop/MasterDashboard/` | `grep -r "chonkius" .` | Should return 0 matches (all paths updated) |
...
- [ ] No remaining hardcoded chonkius/MasterDashboard paths
